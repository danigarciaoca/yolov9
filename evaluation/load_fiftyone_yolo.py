...
dataset_name = "prosegur_person-pet_clean-merged_yolov9"  # FiftyOne dataset name
yaml_path = "coco_test_yolov9/dataset.yml"  # path to the YOLOv5-format dataset YAML file
