...
if __name__ == "__main__":
    ...
    labels_path = Path("coco_test_yolov9_psg/labels/test")
    labels_path.mkdir(parents=True, exist_ok=True)

    # load model
    weights_path = "/home/danigarciaoca/PycharmProjects/yolov9/yolov9/src/runs/train/exp/weights/best.pt"  # model weights
